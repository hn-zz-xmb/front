...
public class FoodPackageSearchController extends BaseController {
	private static Logger log = Logger.getLogger(FoodPackageSearchController.class);
	...
	public void index() {
		...
		Page<FoodPackage> result = FoodPackage.dao.list(pageNum, pageSize, params);
		setAttr("page", result);
